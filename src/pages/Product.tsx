      ...
      <Container style={{ marginTop: "103px" }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: "4px" }}>
            <img src={web} style={{ width: "58px", height: "58px" }} />
            <img src={iOS} style={{ width: "58px", height: "58px" }} />
            <img src={android} style={{ width: "58px", height: "58px" }} />
          </div>
        </div>
        <div
          style={{
      ...
      <Container style={{ marginTop: "160px" }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: "4px" }}>
            ...
            <img src={iOS} style={{ width: "58px", height: "58px" }} />
            <img src={android} style={{ width: "58px", height: "58px" }} />
            <img src={youtube} style={{ width: "58px", height: "58px" }} />
          </div>
        </div>
      </Container>
      <Container style={{ marginTop: "160px" }}>
